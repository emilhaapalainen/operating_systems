...
80104a71:	8b 40 1c             	mov    0x1c(%eax),%eax
  if (num == 5) // sys_read num is 5
80104a74:	83 f8 05             	cmp    $0x5,%eax
80104a77:	74 4f                	je     80104ac8 <syscall+0x68>
  {
    readcount++;
  }
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104a79:	8d 50 ff             	lea    -0x1(%eax),%edx
80104a7c:	83 fa 15             	cmp    $0x15,%edx
80104a7f:	76 27                	jbe    80104aa8 <syscall+0x48>
    curproc->tf->eax = syscalls[num]();
  } else {
    cprintf("%d %s: unknown sys call %d\n",
80104a81:	50                   	push   %eax
            curproc->pid, curproc->name, num);
80104a82:	8d 43 6c             	lea    0x6c(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
80104a85:	50                   	push   %eax
80104a86:	ff 73 10             	push   0x10(%ebx)
80104a89:	68 5d 78 10 80       	push   $0x8010785d
80104a8e:	e8 0d bc ff ff       	call   801006a0 <cprintf>
    curproc->tf->eax = -1;
80104a93:	8b 43 18             	mov    0x18(%ebx),%eax
80104a96:	83 c4 10             	add    $0x10,%esp
80104a99:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
...
80104aa5:	8d 76 00             	lea    0x0(%esi),%esi
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104aa8:	8b 14 85 80 78 10 80 	mov    -0x7fef8780(,%eax,4),%edx
80104aaf:	85 d2                	test   %edx,%edx
80104ab1:	74 ce                	je     80104a81 <syscall+0x21>
    curproc->tf->eax = syscalls[num]();
80104ab3:	ff d2                	call   *%edx
80104ab5:	89 c2                	mov    %eax,%edx
80104ab7:	8b 43 18             	mov    0x18(%ebx),%eax
80104aba:	89 50 1c             	mov    %edx,0x1c(%eax)
}
...
80104ac2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104ac8:	ba 00 4d 10 80       	mov    $0x80104d00,%edx
    readcount++;
80104acd:	83 05 58 3c 11 80 01 	addl   $0x1,0x80113c58
    curproc->tf->eax = syscalls[num]();
80104ad4:	ff d2                	call   *%edx
80104ad6:	89 c2                	mov    %eax,%edx
80104ad8:	8b 43 18             	mov    0x18(%ebx),%eax
80104adb:	89 50 1c             	mov    %edx,0x1c(%eax)
80104ade:	eb dd                	jmp    80104abd <syscall+0x5d>
...
80104c14:	68 f8 78 10 80       	push   $0x801078f8
...
80104c2c:	68 f7 78 10 80       	push   $0x801078f7
...
80104c41:	68 eb 78 10 80       	push   $0x801078eb
...
80104c5f:	68 fa 78 10 80       	push   $0x801078fa
80104c64:	e8 17 b7 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104c69:	83 ec 0c             	sub    $0xc,%esp
80104c6c:	68 dc 78 10 80       	push   $0x801078dc
...
80104d39:	e8 e2 fb ff ff       	call   80104920 <argint>
...
80104d4e:	e8 1d fc ff ff       	call   80104970 <argptr>
...
{
  return readcount;
80105850:	a1 58 3c 11 80       	mov    0x80113c58,%eax
80105855:	c3                   	ret    

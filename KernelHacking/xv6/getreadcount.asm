...
main(void) {
  ...
  11:	e8 0d 03 00 00       	call   323 <grc>
 ...
 33c:	89 d1                	mov    %edx,%ecx
{
 ...
 369:	0f b6 92 94 07 00 00 	movzbl 0x794(%edx),%edx
 ...
 3e9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 459:	ff 24 85 3c 07 00 00 	jmp    *0x73c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 567:	90                   	nop
          s = "(null)";
 568:	ba 33 07 00 00       	mov    $0x733,%edx
        while(*s != 0){
 ...
 581:	a1 3c 0a 00 00       	mov    0xa3c,%eax
{
 ...
 5f9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 5fc:	89 15 3c 0a 00 00    	mov    %edx,0xa3c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 619:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 61c:	8b 3d 3c 0a 00 00    	mov    0xa3c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 65f:	73 4f                	jae    6b0 <malloc+0xa0>
    ...
    if(p == freep)
 661:	8b 3d 3c 0a 00 00    	mov    0xa3c,%edi
 ...
 68a:	e8 f1 fe ff ff       	call   580 <free>
  return freep;
 68f:	8b 15 3c 0a 00 00    	mov    0xa3c,%edx
 ...
 6bc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6bf:	89 15 3c 0a 00 00    	mov    %edx,0xa3c
}
 ...
 6cf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 6d0:	c7 05 3c 0a 00 00 40 	movl   $0xa40,0xa3c
 6d7:	0a 00 00 
    base.s.size = 0;
 6da:	bf 40 0a 00 00       	mov    $0xa40,%edi
    base.s.ptr = freep = prevp = &base;
 6df:	c7 05 40 0a 00 00 40 	movl   $0xa40,0xa40
 6e6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 6e9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 6eb:	c7 05 44 0a 00 00 00 	movl   $0x0,0xa44
 6f2:	00 00 00 
    if(p->s.size >= nunits){
